...
class ToolHang(SingleArmEnv):
    ...
    CAMERA_CONFIGS = dict(
        ...
        birdview=dict(
            ...
            # pos=[0.012517492545096343, -0.4333655864652839, 1.8202695588987103],
            # quat=[0.9862944483757019, 0.16388432681560516, 0.018564462661743164, -0.004534715320914984],

            # pos=[0.00549078785564368, -0.36867659750335113, 1.6311506161603144],
            # quat=[0.9862944483757019, 0.16388432681560516, 0.018564462661743164, -0.004534715320914984],

            # pos=[0.001977435510917347, -0.3363321030223848, 1.5365911447911165],
            # quat=[0.9862944483757019, 0.16388432681560516, 0.018564462661743164, -0.004534715320914984],

            # pos=[-0.40023661167646113, -0.07662203290757696, 1.2791880221954581],
            # quat=[0.7245491147041321, 0.18157072365283966, -0.24287986755371094, -0.6189265847206116],

            # pos=[-0.28851220766367114, -0.06432708885558694, 1.287152447833685],
            # quat=[0.7357774376869202, 0.14269451797008514, -0.19809019565582275, -0.631688117980957],

            # pos=[-0.3121010993643644, -0.06231310480221611, 1.3311923052293058],
            # quat=[0.7357774376869202, 0.14269451797008514, -0.19809019565582275, -0.631688117980957],

            # pos=[-0.3557526580221988, -0.07037393453537312, 1.3081800339534502],
            # quat=[0.7357774376869202, 0.14269451797008514, -0.19809019565582275, -0.631688117980957],

            # pos=[-0.3356854029579361, -0.07205245523057924, 1.2630467728946015],
            # quat=[0.7270485758781433, 0.16914907097816467, -0.23185718059539795, -0.6237238645553589],

            pos=[-0.3630927742813304, -0.06988894126435229, 1.304809869438605],
            quat=[0.7270485758781433, 0.16914907097816467, -0.23185718059539795, -0.6237238645553589],
        ),
    )
